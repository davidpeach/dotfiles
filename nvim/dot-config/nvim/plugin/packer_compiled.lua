...
_G.packer_plugins = {
  ...
  ["mason.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-dadbod"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-dadbod",
    url = "https://github.com/tpope/vim-dadbod"
  },
  ["vim-dadbod-ui"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-dadbod-ui",
  ...
  ["vim-tmux-runner"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-tmux-runner",
  ...
  ["wiki.vim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/wiki.vim",
