...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["gruvbox-baby"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/gruvbox-baby",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  phpactor = {
    config = { "\27LJ\2\n›\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0|  augroup PhpactorMappings\n    au!\n    au FileType php nmap <buffer> <Leader>mm :PhpactorContextMenu<CR>\n  augroup END\n\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/Users/david/.local/share/nvim/site/pack/packer/opt/phpactor",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/popup.nvim",
    url = "https://github.com/nvim-lua/popup.nvim"
  },
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["vim-lastplace"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-lastplace",
    url = "https://github.com/farmergreg/vim-lastplace"
  },
  ["vim-rooter"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-rooter",
    url = "https://github.com/airblade/vim-rooter"
  },
  ["vim-test"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-test",
