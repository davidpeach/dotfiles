  ...
  },
  {
    ...
    init = function ()
      vim.cmd([[
        ...
        let test#php#pest#executable = 'docker compose exec -T coh-php-fpm php artisan test'
...
vim.cmd([[
  au FileType * hi NormalFloat guifg=auto guibg=auto
  au FileType * hi FloatBorder guifg=salmon guibg=auto
]])
